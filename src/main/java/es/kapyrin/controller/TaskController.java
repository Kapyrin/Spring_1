package es.kapyrin.controller;

import es.kapyrin.domain.Task;
import es.kapyrin.service.TaskService;
...
public class TaskController {
    ...
    public String edit(Model model,
        ...
        if (isNull(id) || id <= 0) throw new RuntimeException("Wrong id");
        Task editedTask = taskService.edit(id, info.getDescription(), info.getStatus());
